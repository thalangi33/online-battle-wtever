    ...
    <div className="Word_UI-container">
      ...
      <div className='tile-box'>
        <div className='tile-row'>
          <div className='tile guess-1-1'>{answer.slice(0,1)}</div>
          <div className='tile guess-1-2'>{answer.slice(1,2)}</div>
          <div className='tile guess-1-3'>{answer.slice(2,3)}</div>
          <div className='tile guess-1-4'>{answer.slice(3,4)}</div>
          <div className='tile guess-1-5'>{answer.slice(4,5)}</div>
        </div>
        <div className='tile-row'>
          <div className='tile guess-1-1'>{answer.slice(0,1)}</div>
          <div className='tile guess-1-2'>{answer.slice(1,2)}</div>
